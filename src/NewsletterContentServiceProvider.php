...
class NewsletterContentServiceProvider extends AuthServiceProvider
{
    use Settable;
     ...
     */
    protected $policies = [
        Models\Newsletter::class => Policies\NewsletterPolicy::class
    ];
     ...
     */
    protected $commands = [
        Commands\NewsletterInstaller::class,
    ];
     ...
     */
    protected $settings = [
        // 'newsletter' => Settings\NewsletterSettings::class
    ];
